...
export default function CategoryExplanations({ locale, motion }: CategoryExplanationsProps) {
  const explanations: Record<string, { en: string; es: string }> = {
    function: {
      en: `
        <p class="mb-2">A connector's function is the semantic relationship it signals between parts of discourse. Common functions include addition, contrast, cause, result, condition, time, illustration, emphasis, and conclusion.</p>
        <h4 class="font-semibold mt-2">Main characteristics</h4>
      ...
      `,
      es: `
        <p class="mb-2">La función indica la relación semántica que marca el conector: adición, contraste, causa, resultado, condición, tiempo, ilustración, énfasis, conclusión, etc.</p>
        <h4 class="font-semibold mt-2">Características</h4>
        <ul class="list-disc list-inside mt-1">
    ...
    grammar: {
      ...
      `,
      es: `
        <p class="mb-2">El tipo gramatical describe la función estructural: coordinante, subordinante, correlativo, adverbio conjuntivo, preposicional o frase multi-palabra.</p>
        <h4 class="font-semibold mt-2">Coordinantes — características principales</h4>
        <p class="mt-1">Unen estructuras equivalentes: palabra + palabra, frase + frase, cláusula + cláusula. Ponen en relación elementos del mismo nivel.</p>
        <h4 class="font-semibold mt-2">Puntuación</h4>
        <p class="mt-1">Cuando unen dos oraciones independientes se usa coma antes del coordinante: "Quise ir, pero estaba ocupado."</p>
        <h4 class="font-semibold mt-2">Errores comunes</h4>
        <ul class="list-disc list-inside mt-1">
    ...
    punctuation: {
      ...
      `,
      es: `
        <p class="mb-2">Describe las marcas de puntuación habituales con cada conector: coma, punto y coma, dos puntos, o ninguna.</p>
        <p class="mt-1">Ejemplo: coma antes de "but" cuando une oraciones independientes.</p>
      `,
    },
    cefr: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">Nivel MCER indica cuándo suele enseñarse el conector. Útil para secuenciar la enseñanza.</p>
      `,
    },
    register: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">El registro indica el tono: informal, neutral, formal o literario, y ayuda a elegir formas apropiadas según el contexto.</p>
      `,
    },
    position: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">Posición: inicial, medial o final. Ejemplo: "However, ..." (inicial) o "..., however, ..." (medial).</p>
      `,
    },
    structure: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">Estructura: palabra única, compuesta o frase multi-palabra. Enseña primero formas cortas y frecuentes.</p>
      `,
    },
    frequency: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">Frecuencia: alta, media o baja. Las de alta frecuencia deben enseñarse antes y reforzarse.</p>
      `,
    },
    rhetorical: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">Función retórica: argumentación, narrativa, exposición o persuasión. Indica para qué tipo de texto es más útil el conector.</p>
      `,
    },
    origin: {
      en: `
      ...
      `,
      es: `
        <p class="mb-2">Origen: nativo, préstamos latinos/franceses o híbridos. Aporta información etimológica y sobre registro.</p>
      `,
    },
  };
